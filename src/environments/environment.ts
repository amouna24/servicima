...
export const environment = {
  ...
  resumeProfessionalExperienceApiUrl: 'http://127.0.0.1:8075/servicima/resumeprofessionalexperience/v1',
  resumeProjectApiUrl: 'http://127.0.0.1:8076/servicima/resumeproject/v1',
