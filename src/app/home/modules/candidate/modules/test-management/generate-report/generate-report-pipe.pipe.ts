...
export class GenerateReportPipePipe implements PipeTransform {

  transform(donutSlices, radius: number, svgSize: number, borderSize: number) {
  ...
  getSliceCommands(donutSlice, radius: number, svgSize: number, borderSize: number): string {
