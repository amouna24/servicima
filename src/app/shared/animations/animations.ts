...
export function notifAnimation(animationDuration: string = defaultDuration, ): AnimationTriggerMetadata {
    return trigger('notifAnimation', [
        state('close', style({
            display: 'flex',
...
export function notiffAnimation(animationDuration: string = defaultDuration, ): AnimationTriggerMetadata {
    return trigger('notiffAnimation', [
        state('close', style({
            display: 'inline',
            'margin-left': '-12px',
            'margin-top': '13px'
